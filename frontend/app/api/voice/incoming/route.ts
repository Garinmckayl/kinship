...
// Twilio hits this when Eleanor answers. Speaks + listens in a loop.
export async function POST(req: Request) {
  ...
  const twiml =
    ...
    `</Gather>` +
    `<Say voice="Polly.Joanna-Neural" language="en-US">I didn't catch that. Goodbye for now, Eleanor. I'll check back soon.</Say>` +
    `</Response>`;
